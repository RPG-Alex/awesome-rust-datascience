...
- [flodl](https://github.com/flodl-labs/flodl) — Rust-native deep learning framework built on [libtorch](https://github.com/pytorch/pytorch/blob/main/docs/libtorch.rst).
...
- [ordofp](https://github.com/ordokr/ordofp) — A powerful rust library of functional programming abstractions. 
